...
//   Input         :  File Descriptor,address of buffer which 
//                    contains data,size of data that we want to write
...
//////////////////////////////////////////////////////////////////////
  ...
  {
     printf("File Desccriptor: %d\n",fd);
     printf("Data that we want to write: %s\n",data);
     printf("Number of bytes that wee want to write : %d\n",Size);
    ...
    while(1)
    {
      ...
      else if(iCount == 2)
      {
        ...
        // Marvellous CVFS: > man
         ...
         if(strcmp("unlink",Command[0]) == 0)
         {
            ...
            {
                printf("File gets Successfully executed\n");
            }
         }
      ...
      { 
        ...
        if(strcmp("creat",Command[0]) == 0)
         ...
         {
            printf("There is no such commamd\n");
         }
      } //end of else if 3
      else if(iCount == 4)
      {
